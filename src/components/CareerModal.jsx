...
//         <button
//           onClick={onClose}
//           className="absolute p-2 text-gray-300 transition-colors duration-200 rounded-full top-6 right-6 hover:text-white hover:bg-white/10"
//         >
...
//           />
//           <div className="absolute px-4 py-2 text-sm font-semibold text-white rounded-full shadow-lg top-4 left-4 bg-gradient-to-r from-purple-600 to-indigo-600">
//             {career.industry}
//           </div>
//         </div>
...
//           <div>
//             <h2 className="mb-3 text-4xl font-bold text-purple-200">
//               {career.title}
//             </h2>
...
//           <div className="p-6 border bg-white/10 rounded-2xl border-white/20">
//             <div className="flex items-center justify-between mb-4">
//               <h3 className="text-xl font-semibold text-white">Salary Range</h3>
//               <span className="px-3 py-1 text-sm font-semibold text-purple-300 rounded-full bg-purple-500/20">
//                 {Math.round(progress)}% of market max
//               </span>
//             </div>

//             <p className="mb-4 text-3xl font-bold text-green-300">
//               ${career.salaryMin.toLocaleString()} – ${career.salaryMax.toLocaleString()}
//             </p>

//             <div className="w-full h-4 rounded-full shadow-inner bg-gray-700/50">
//               <div
//                 className="h-4 rounded-full shadow-lg bg-gradient-to-r from-purple-500 to-indigo-500"
...
//                   <span
//                     key={index}
//                     className="px-4 py-2 text-sm font-medium text-purple-200 border rounded-full bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border-purple-400/30"
//                   >
//                     {skill}
//                   </span>
//                 ))}
...
//               className="flex items-center justify-center flex-1 px-6 py-4 font-bold text-white transition-all duration-300 transform shadow-lg bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl hover:from-purple-700 hover:to-indigo-700 hover:scale-105"
//             >
...
//             <button
//               onClick={onClose}
//               className="px-6 py-4 font-semibold text-white transition-all duration-300 border bg-white/10 rounded-xl hover:bg-white/20 border-white/20"
//             >
//               Close
//             </button>
//           </div>
