...
//       className="flex flex-col p-6 transition-all duration-300 shadow-lg bg-white/5 backdrop-blur-lg rounded-3xl ring-1 ring-white/10 hover:shadow-2xl"
//     >
...
//           className="px-4 py-2 text-sm font-semibold text-white transition bg-purple-600 rounded-full hover:bg-purple-700"
//         >
//           Bookmark
//         </button>
//       </div>
